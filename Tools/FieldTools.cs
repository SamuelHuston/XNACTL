...
namespace XNACTL
{
    ...
    {
        public static Field GenerateFractalNoise(int width, int height, int depth, double wavelength, double fraction)
        {
            ...
            for (int z = 1; z < depth + 1; z++)
                for (int y = 0; y < height; y++)
                    ...
                    {
                        double xIn = (double)x / (wavelength / z);
                        double yIn = (double)y / (wavelength / z);
                        double zIn = (double)z;
